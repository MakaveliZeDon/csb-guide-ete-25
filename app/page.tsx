...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-rose-100">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Découvrez les conseils d'experts pour prévenir et gérer les infections urinaires pendant la période
                  estivale. Un guide complet rédigé par 6 professionnels de santé reconnus.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700 font-medium">Conseils de 6 experts</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="flex-shrink-0">
                    <CheckCircle className="h-6 w-6 text-green-500" />
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700 font-medium">Conseils pratiques</span>
                </div>
              </div>
              ...
              <div className="relative mx-auto max-w-md">
                ...
                <div className="relative bg-white rounded-2xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-300">
                  ...
                  <div className="mt-4 text-center">
                    <h3 className="font-bold text-gray-900">Guide Anti-Cystite</h3>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Rédigé par 6 professionnels de santé</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Un guide complet élaboré par une équipe pluridisciplinaire d'experts reconnus dans leur domaine.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <CardContent>
                  <CardDescription className="text-center text-gray-600">{expert.desc}</CardDescription>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-blue-50 to-indigo-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Ce que vous allez découvrir</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Un guide pratique avec des conseils concrets pour profiter pleinement de votre été.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { icon: "🩱", title: "Hygiène intime", desc: "Les bonnes pratiques adaptées aux activités estivales" },
              {
                icon: "🌿",
                title: "Remèdes naturels",
                desc: "Solutions naturelles efficaces et sans effets secondaires",
              },
              { icon: "🚨", title: "Gestion des crises", desc: "Que faire en cas de symptômes pendant vos vacances" },
              { icon: "✅", title: "Check-list vacances", desc: "Votre trousse de secours anti-cystite à emporter" },
            ].map((item, index) => (
              <Card
                key={index}
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Déjà plus de 10 000 femmes conquises</h2>
          </div>
      ...
      <section id="download-form" className="py-16 md:py-24 bg-gradient-to-br from-pink-50 via-rose-50 to-orange-50">
        <div className="container mx-auto px-4">
            ...
            {!isSubmitted ? (
              <Card className="border-0 shadow-2xl">
                <CardHeader className="text-center pb-8">
                  ...
                  <CardDescription className="text-lg text-gray-600">
                    Saisissez vos informations ci-dessous pour recevoir immédiatement votre guide par email
                  </CardDescription>
                </CardHeader>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <label htmlFor="newsletter" className="text-sm text-gray-700 leading-relaxed cursor-pointer">
                          Je souhaite recevoir des conseils santé et bien-être par email (optionnel)
                        </label>
                      </div>
              ...
              <Card className="border-0 shadow-2xl">
                <CardContent className="text-center py-12">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Merci {formData.firstName} ! 🎉</h3>
                  <p className="text-lg text-gray-600 mb-2">
                    Votre guide a été envoyé à <strong>{formData.email}</strong>
                  </p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          <div className="space-y-4">
            <p className="text-lg font-semibold">Guide Anti-Cystite - Votre Été Serein</p>
            <p className="text-gray-400">
              © 2024 - Tous droits réservés • Conseils rédigés par des professionnels de santé qualifiés
            </p>
            <p className="text-sm text-gray-500">
              Les informations fournies sont à titre éducatif. Consultez votre médecin pour un diagnostic personnalisé.
            </p>
          </div>
        </div>
      </footer>
